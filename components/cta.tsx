      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/15 px-5 py-2 text-sm font-semibold mb-6">
            ...
            <span>Coming Soon - Built on Brakto's Proven Infrastructure</span>
          </div>
          ...
          <p className="mt-6 text-xl text-white/90 text-pretty leading-relaxed max-w-3xl mx-auto">
            ScholarArena is currently in development. Join our waitlist to be notified when we launch and get early access to our four-portal platform for academic competition management.
          </p>
          ...
          <p className="mt-8 text-sm text-white/70 font-medium">
            Interested in partnership opportunities? Contact us at info@scholararena.com
          </p>
        </div>
      </div>
    </section>
